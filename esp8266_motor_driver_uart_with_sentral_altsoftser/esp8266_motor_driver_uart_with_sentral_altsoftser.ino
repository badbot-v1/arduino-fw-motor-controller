...
#define CMD_DRIVELINE   HDR_QUALIFIER | 0x02
#define TELE_IMU        HDR_QUALIFIER | 0x03
...
//byte telemetry_data_serialized[sizeof(TELEMETRY_IMU)]; //+1 for header
byte magic_header[4]={0xFA,0xAA,0xAA,0XAF};
...
bool readSoftSerial(AltSoftSerial *ss, uint32_t  numBytesToRead, byte *buffer)
{
